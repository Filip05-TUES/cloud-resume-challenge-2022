document.addEventListener("DOMContentLoaded", () => {
  ...
  if (!counted) {
    fetch('https://eful2ova17.execute-api.us-east-1.amazonaws.com/visitor', { method: 'POST' })
      .then(res => res.text())
      .then(count => {
    ...
    fetch('https://eful2ova17.execute-api.us-east-1.amazonaws.com/visitor', { method: 'GET' })
      .then(res => res.text())
